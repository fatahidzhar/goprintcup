@section('navbar')
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-4 rounded dark:bg-gray-900">
        ...
        <div class="flex items-center md:order-2">
            ...
            <img class="w-8 h-8 rounded-full" src="https://placeimg.com/192/192/people" alt="user photo">
            </button>
            <!-- Dropdown menu -->
