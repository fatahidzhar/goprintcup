...
<form class="p-5" action="{{ route('size.update', $data->id_size) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="grid gap-6 mb-6 md:grid-cols-3">
        <div>
            <label for="size" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Code Size</label>
            <input type="text" value="{{ $data->id_size }}" name="id_size" id="size" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" readonly required>
        </div>
        <div>
            @endforeach
        ...
        <div>
            ...
            <input type="text" id="product" value="{{ $data->name_size }}" name="name_size" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
            @endforeach
        </div>
    </div>
